...
<button>App Store</button> 
    ...
    render() {
        this.wrapper.insertAdjacentHTML("beforebegin", this.creatHeader());
        this.wrapper.insertAdjacentHTML("beforebegin", this.creatHeroSection());
    }
};
